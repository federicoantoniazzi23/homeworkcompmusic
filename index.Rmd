...
# Codice per il secondo grafico 'ska'
ska_plot <- ska |> 
  compmus_match_pitch_template(
    chord_templates,
    method = "euclidean",
...
plot_grid(stomaco_plot, ska_plot, nrow = 2)
...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=kZFtL1aoels" frameborder="0" allowfullscreen></iframe>
