...
```{r, echo=FALSE, out.width='1%', fig.align='down'}
library(knitr)
include_graphics("fotor.png")
...
```{r "A quick look around España Circo Este's discography", fig.width=8, fig.height=6}
library(ggplot2)
library(plotly)
library(tidyverse)
library(spotifyr)
...
gg <- ggplot(fulldiscography, aes( color = track.album.name, text = paste("Track Name:", track.name, "<br>",
                                                                                                                                          "Release Date:", track.album.release_date), x = valence, y = danceability,size = track.popularity)) +
